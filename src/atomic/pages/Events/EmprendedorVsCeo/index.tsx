  ...
  return (
    <main className="overflow-hidden bg-cream text-ink-900">
      ...
      <section className="relative overflow-hidden bg-ink-900 text-cream">
        ...
        <div className="relative z-[2] mx-auto max-w-[1312px] px-5 py-20 sm:px-8 sm:py-24 lg:px-16 lg:py-28">
          <div className="mb-10 flex flex-col gap-3 border-b border-cream/20 pb-5 text-[10px] font-medium uppercase tracking-[0.30em] text-cream/55 sm:flex-row sm:items-center sm:justify-between">
            <span><span className="text-[#8a6a3d]">— 00</span> Evento gratuito 2026</span>
            <span>Diego Díaz · Estratega fiscal</span>
          </div>

          <h1 className="font-sans font-bold leading-[0.94] tracking-[-0.055em] text-cream text-[64px] sm:text-[110px] lg:text-[160px] xl:text-[200px]">
            <span className="block">Tablero</span>
            <span className="block">
              del <span className="text-[#8a6a3d]">CEO</span>
      ...
      <section className="relative overflow-hidden border-t border-cream/10 bg-ink-900 px-5 py-32 text-cream sm:px-8 lg:px-16">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_10%_90%,rgba(180,150,110,0.16),transparent_62%)]" />
