...
import logoExcelsior from "../../../../assets/home/010_home_logo4_DD.png";
import logoTeleformula from "../../../../assets/home/010_home_logo5_DD.png";
import logoSemanario from "../../../../assets/home/010_home_logo6_DD.png";
import logoPrensa7 from "../../../../assets/home/010_home_logo7_DD.png";
import logoPrensa8 from "../../../../assets/home/010_home_logo8_DD.png";
import logoPrensa9 from "../../../../assets/home/010_home_logo9_DD.png";
import logoPrensa10 from "../../../../assets/home/010_home_logo10_DD.png";
import logoPrensa11 from "../../../../assets/home/010_home_logo11_DD.png";
import logoPrensa12 from "../../../../assets/home/010_home_logo12_DD.png";
import logoPrensa14 from "../../../../assets/home/010_home_logo14_DD.png";
...
function CountdownUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-start">
      ...
      <span className="text-[11px] uppercase tracking-[0.3em] text-ink-300 mt-1">
        {label}
      </span>
    </div>
  );
...
function BookTilt({
  ...
  const resetTilt = useCallback(() => {
    ...
    if (!el) return;
    el.style.transition =
      "transform 600ms cubic-bezier(.2,.8,.2,1), filter 600ms cubic-bezier(.2,.8,.2,1)";
    el.style.transform =
...
const MEDIA_LOGOS = [
  ...
  { src: logoPrensa7, alt: "Medio de prensa 7" },
  { src: logoPrensa8, alt: "Medio de prensa 8" },
  { src: logoPrensa9, alt: "Medio de prensa 9" },
  { src: logoPrensa10, alt: "Medio de prensa 10" },
  { src: logoPrensa11, alt: "Medio de prensa 11" },
  { src: logoPrensa12, alt: "Medio de prensa 12" },
  { src: logoPrensa14, alt: "Medio de prensa 14" },
  { src: logoPrensa15, alt: "Medio de prensa 15" },
  { src: logoPrensa16, alt: "Medio de prensa 16" },
  { src: logoPrensa17, alt: "Medio de prensa 17" },
];
...
const TESTIMONIALS = [
  {
    ...
    richQuote: (
      <>
        ...
        Ahora entiendo <strong className="font-bold">cómo funciona</strong>{" "}
        realmente el SAT…{" "}
        <em className="font-serif italic">y duermo mejor por las noches.</em>"
      </>
    ),
  },
  {
    ...
    richQuote: (
      <>
        "Pensé que ya lo sabía todo sobre{" "}
        <em className="font-serif italic">deducibilidad.</em> Diego me demostró
        que estaba dejando el <strong className="font-bold">30%</strong> sobre
        la mesa <em className="font-serif italic">cada año.</em>"
      </>
    ),
  },
];
...
export default function Home() {
  ...
  const c25 = useCountUp(20, statsInView);
        ...
        <div className="container-app py-16 md:py-20">
          <div className="grid lg:grid-cols-[0.55fr_0.45fr] gap-10 lg:gap-12 xl:gap-20 items-center">
            ...
            <AnimateIn variant="slide-right" className="flex justify-center">
              <div
                className="relative aspect-[4/5] w-full max-w-[430px] overflow-hidden bg-black cursor-pointer"
                onClick={toggleVideo}
              >
                <video
                  ref={videoRef}
      ...
      <section className="bg-cream-200 py-16 md:py-20">
        <div className="container-app">
          <AnimateIn className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-10">
            <div>
              <div className="mb-4">
                <p className="text-[11px] uppercase tracking-[0.35em] text-ink-400 leading-none">
                  02 /
                </p>
                <p className="text-[11px] uppercase tracking-[0.35em] text-ink-400">
                  Calendario
                </p>
              </div>
              <h2 className="section-title">
                Todos los <strong className="font-bold">escenarios.</strong>
                <br />
            ...
            <Link
              to="/eventos"
              className="text-[11px] uppercase tracking-[0.3em] text-ink-400 hover:text-ink-900 transition-colors underline decoration-1 underline-offset-4"
            >
              Ver todos →
            </Link>
          </AnimateIn>
              ...
              >
                ...
                <div className="p-5 flex flex-col gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[22px] font-serif italic text-ink-900 leading-tight">
                      {featured.titleLine2}
                    </p>
                  </div>
                ...
                >
                  ...
                  <div className="p-4 flex flex-col gap-2 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-[17px] font-serif italic text-ink-900 leading-tight">
                        {ev.titleLine2}
                      </p>
                    </div>
        ...
        <div className="container-app">
          ...
          <AnimateIn className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-12">
            <div>
              ...
              <h2 className="section-title">
                El <strong className="font-bold">experto</strong> detrás
                <br />
                de las decisiones
              </h2>
            </div>
            ...
            <AnimateIn variant="slide-left" delay={120}>
              <div className="space-y-8 lg:pt-4">
                <blockquote className="text-[clamp(24px,3vw,40px)] font-normal leading-snug text-ink-900">
                  ...
                  <em className="font-serif italic">Diego diseña</em> soluciones
                  donde otros ven problemas"
                </blockquote>

                <p className="text-[13px] text-ink-500 leading-relaxed max-w-md">
                  Licenciado en Contaduría y Finanzas, especializado en derecho
                  corporativo y estrategia fiscal. En 2024 escribió historia con
                  el primer acuerdo conclusivo en defensa de una agencia de
                  viajes. Resolvió en 4 días hábiles el bloqueo de certificado
                  de una empresa de +1,000 empleados.
                </p>

                {/* Stats — Demo 07 counter animation */}
                <div
                  ref={statsRef}
                  className="grid grid-cols-2 sm:grid-cols-4 border border-cream-400"
                >
                  {[
                    { display: String(c25), label: "Años de\ntrayectoria" },
                    { display: `${c10}k+`, label: "Empresarios\ncapacitados" },
                    {
                      display: String(c3).padStart(2, "0"),
                      label: "Libros\npublicados",
                    },
                    ...
                    >
                      <span className="text-[clamp(26px,3.5vw,44px)] font-normal text-ink-900 leading-none tabular-nums">
                        {display}
                      </span>
                      <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.16em] sm:tracking-[0.2em] text-ink-400 whitespace-pre-line mt-2 leading-snug">
                        {label}
                      </span>
                    </div>
                  ))}
        ...
        <div className="container-app">
          <AnimateIn className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-10">
            <div>
              ...
              <h2 className="section-title">
                <strong className="font-bold">Tres</strong> caminos.
                <br />
                Con dirección{" "}
                <em className="font-serif italic font-normal">estratégica.</em>
              </h2>
            </div>
            <Link
              to="/recursos"
            ...
            {SERVICES.map((s, idx) => {
              const ctaClass = `flex items-center justify-between gap-4 text-[11px] uppercase tracking-[0.2em] sm:tracking-[0.25em] pt-4 border-t group cursor-pointer ${
                s.dark
                  ...
                  : "border-cream-400 text-ink-500 hover:text-ink-900"
              }`;
              ...
              const ctaContent = (
                <>
                  <span className="min-w-0 leading-relaxed">{s.cta}</span>
              ...
              return (
                ...
                >
                  <div
                    className={`p-6 sm:p-8 flex flex-col gap-5 flex-1 hover:-translate-y-1.5 transition-transform duration-[400ms] ease-[cubic-bezier(.2,.8,.2,1)] ${s.dark ? "bg-ink-900" : "bg-white"}`}
                  >
                    <div className="flex items-start justify-between">
                      <span className="text-[11px] uppercase tracking-[0.3em] text-ink-400">
                        {s.label}
                      </span>
                      <span
                        className={`text-[11px] uppercase tracking-[0.2em] ${s.dark ? "text-ink-600" : "text-ink-200"}`}
                      >
                        {idx + 1}.
                      </span>
                    </div>
                    ...
                    <h3
                      className={`text-[clamp(22px,2.5vw,28px)] font-serif italic font-normal ${s.dark ? "text-white" : "text-ink-900"}`}
                    >
                      {s.title}
                    </h3>

                    <p
                      className={`text-[13px] leading-relaxed flex-1 ${s.dark ? "text-ink-300" : "text-ink-500"}`}
                    >
                      {s.desc}
                    </p>
                    ...
                    {s.link.startsWith("http") ? (
                      ...
                      <Link to={s.link} className={ctaClass}>
                        {ctaContent}
                      </Link>
                    )}
                  </div>
        ...
        <div className="container-app">
          ...
          <AnimateIn className="text-center max-w-3xl mx-auto space-y-7">
            <h2 className="text-[clamp(30px,8vw,60px)] font-normal leading-tight text-ink-900">
              ¿Tu <strong className="font-bold">empresa</strong> necesita
              <br />
              una{" "}
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 py-2">
              {[
                ...
                <span
                  key={cert}
                  className="text-[11px] uppercase tracking-[0.25em] text-ink-400"
                >
                  {cert}
                </span>
              ))}
