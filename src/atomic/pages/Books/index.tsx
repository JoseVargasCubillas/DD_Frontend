...
function BookStack() {
  return (
    <div className="group relative mx-auto h-[330px] w-full max-w-[520px] cursor-pointer [perspective:1400px] sm:h-[420px] lg:h-[440px] lg:max-w-[560px]">
      ...
      <img
        src={bookSat}
        alt="Portada Los 7 secretos que el SAT no quiere que conozcas"
        className={`absolute right-[4%] top-[19%] h-[235px] w-[149px] rotate-[7deg] border ${border} object-cover shadow-xl transition-all duration-300 ease-out [transform-style:preserve-3d] group-hover:translate-x-4 group-hover:-translate-y-2 group-hover:rotate-[11deg] group-hover:shadow-[0_28px_54px_rgba(0,0,0,0.22)] sm:h-[315px] sm:w-[200px] lg:h-[355px] lg:w-[225px]`}
      />
    </div>
  );
}
    ...
    <div className="bg-cream-200 text-ink-900">
      <section className="container-app min-h-[760px] border-b border-ink-900/10 py-10 sm:py-12 lg:min-h-[860px] lg:py-14">
        <div className={`${mono} flex justify-between gap-6 border-b border-ink-900/10 pb-7`}>
          ...
          <span>Envio a todo Mexico y LATAM</span>
        </div>
        ...
        <div className="mt-10 grid gap-12 lg:grid-cols-[0.48fr_0.52fr] lg:items-start">
          <div className="lg:pt-7">
            ...
            <p className="mt-8 max-w-[430px] text-[15px] leading-[1.75] text-ink-900/62">
              Mas de 50,000 lectores en Mexico, Colombia, Peru y Espana. Los libros de Diego no son manuales de impuestos: son herramientas de decision para empresarios que prefieren leer antes de pagar.
            </p>
        ...
        <div className="grid gap-14 pt-16 lg:grid-cols-[0.9fr_1fr] lg:items-center lg:gap-24">
          ...
          <div>
            ...
            <p className="mt-8 max-w-[560px] text-[15px] leading-[1.8] text-ink-900/64">
              El primer libro de Diego. Una guia practica sobre como extraer valor de tu empresa sin destruir su flujo, sin pelearte con tu contador, y sin meterte en problemas con el SAT. Pensado para empresarios entre 5 y 100 colaboradores.
            </p>

            <div className="mt-7 border border-ink-900/10 px-8 py-7">
              <p className={mono}>— Indice resumido · 7 capitulos</p>
              <div className="mt-5 divide-y divide-ink-900/10 text-[14px] leading-none">
                {[
                  ['Sueldo', 'si, pero ¿cuanto y como?'],
                  ['El dividendo', 'cuando si y cuando no'],
                  ['Honorarios cruzados entre socios'],
                  ['Renta de bienes del socio a la empresa'],
                  ['Prestamos: la ruta mas malentendida'],
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              {[
                ['"Me ahorro tres reuniones con mi contador y una buena cantidad de dinero el primer trimestre."', 'Patricia Ortega · CEO Operadora Bajio'],
                ['"Por fin entendi que firmo cada ano fiscal."', 'Andres Cuevas · Director financiero'],
              ].map(([quote, author]) => (
            ...
            <div className="mt-9 flex flex-col gap-5 border-t border-ink-900/10 pt-8 sm:flex-row sm:items-end">
              <div className="min-w-[130px]">
                ...
                <p className="mt-1 text-[11px] tracking-[0.22em] text-ink-900/38">MXN · Envio incluido</p>
              </div>
            ...
            <div className={`${mono} mt-8 grid gap-3 border-t border-ink-900/10 pt-7 sm:grid-cols-2`}>
              <span>★ 288 paginas</span>
              <span>★ Pasta blanda</span>
              <span>★ Impreso en Mexico</span>
      ...
      <section className="container-app border-b border-ink-900/10 py-20 lg:py-28">
        ...
        <div className="grid gap-14 pt-14 lg:grid-cols-[0.96fr_1fr] lg:items-center lg:gap-24">
          <div>
            ...
            <p className="mt-8 max-w-[560px] text-[15px] leading-[1.8] text-ink-900/64">
              El libro mas vendido de Diego, y el que mas controversia ha generado. Una lectura inteligente sobre el funcionamiento real de la autoridad fiscal mexicana, sus puntos ciegos y las herramientas que la propia ley te entrega. Tercera edicion agotada en marzo 2026.
            </p>
            ...
            <div className="mt-8 max-w-[590px] bg-white/55 px-8 py-7">
              ...
              <div className="mt-5 divide-y divide-ink-900/10 text-[14px] leading-none">
                {[
                  ...
                  ['Lo que el Buzon Tributario', 'no es'],
                  ['Acuerdos conclusivos: tu carta oculta'],
                  ['Devoluciones automaticas: el secreto del PAE'],
                  ['El catalogo invisible de las "operaciones simuladas"'],
                  ['Cuando conviene', 'auto-corregirte'],
            ...
            <div className="mt-7 max-w-[590px] border border-ink-900 px-8 py-7">
              <h3 className="font-serif text-[26px]">
                Lista de <em className="italic">espera</em> · Reimpresion 2026
              </h3>
              <p className="mt-3 max-w-[480px] text-[13px] leading-relaxed text-ink-900/62">
                Avisame cuando vuelva a estar disponible. Mientras tanto, descarga gratis el capitulo 1 completo (35 paginas).
              </p>
              <form className="mt-5 flex border border-ink-900/15 bg-white">
                <label className="sr-only" htmlFor="sat-waitlist-email">Correo electronico</label>
        ...
        <div className="container-app grid gap-16 lg:grid-cols-[0.96fr_1fr] lg:items-center lg:gap-24">
          ...
          <div>
            ...
            <p className="mt-8 max-w-[590px] text-[15px] leading-[1.8] text-white/62">
              El libro mas reciente y posiblemente el mas util. Diego comparte la mentalidad detras de 25 anos de practica: como piensa, como decide y como construye estrategia un fiscalista mexicano que asesora a empresas medianas y grandes. Premio Mejor Libro de Negocios LATAM 2025.
            </p>

            <div className="mt-8 border border-white/12 bg-white/[0.03] px-8 py-7">
              <p className="font-mono text-[10px] uppercase tracking-[0.34em] text-white/38">— Indice resumido · 7 capitulos</p>
              <div className="mt-5 divide-y divide-white/10 text-[14px] leading-none">
                {[
                  ['La arquitectura', 'antes que el truco'],
                  ['Por que un cliente no es un caso'],
                  ['El metodo de los', 'tres folders'],
                  ['La pregunta que destraba toda asesoria'],
                  ['Como cobrar como estratega y no como contador'],
                  ['El ano fiscal en cinco bloques'],
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              {[
                ['"El libro que me hubiera ahorrado diez anos de errores en mi despacho."', 'Luis Hernandez · Socio fundador, HN Asociados'],
                ['"No es un manual: es una filosofia aplicada."', 'Maria de los Angeles Soto · CPA'],
              ].map(([quote, author]) => (
            ...
            <div className="mt-9 flex flex-col gap-5 border-t border-white/10 pt-8 sm:flex-row sm:items-end">
              <div className="min-w-[130px]">
                ...
                <p className="mt-1 text-[11px] tracking-[0.22em] text-white/36">MXN · Envio incluido</p>
              </div>
            ...
            <div className="mt-8 grid gap-3 border-t border-white/10 pt-7 font-mono text-[10px] uppercase tracking-[0.34em] text-white/38 sm:grid-cols-2">
              <span>★ 340 paginas</span>
              <span>★ Pasta dura · Tapa de lino</span>
              <span>★ Premio LATAM 2025</span>
              <span>★ Edicion limitada firmada disponible</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-app grid gap-14 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:gap-24">
          <div>
            ...
            <p className="mt-8 max-w-[520px] text-[15px] leading-[1.8] text-white/62">
              La biblioteca completa del estratega fiscal mexicano. Edicion especial con caja de lino impresa, tres libros y dedicatoria firmada por Diego a quien tu elijas.
            </p>
      ...
      <section className="container-app border-b border-ink-900/10 py-20 lg:py-28">
        <div className="grid gap-14 lg:grid-cols-[0.92fr_1.08fr] lg:items-center lg:gap-24">
          <div>
            ...
            <img
              src={diegoAuthor}
              alt="Diego Diaz, autor de los libros"
          ...
          <div>
            ...
            <p className={`${mono} mt-20`}>— El estratega detras de los tres libros</p>
            ...
            <p className="mt-9 max-w-[590px] text-[15px] leading-[1.8] text-ink-900/62">
              Diego Diaz es contador publico y especialista fiscal mexicano. Fundador y director de Diaz Lara Consultores. En 25 anos de practica ha asesorado a mas de 1,800 empresas mexicanas y formado a +10,000 directivos en seminarios y eventos presenciales. Sus libros se leen en universidades de negocios de Mexico, Colombia y Peru.
            </p>
      ...
      <section className="container-app py-20 text-center lg:py-28">
        ...
        <p className="mx-auto mt-7 max-w-[610px] text-[15px] leading-[1.75] text-ink-900/60">
          Cada domingo a las 7am mando una carta de tres minutos con un analisis nuevo, una estrategia y una recomendacion de lectura. La reciben +38,000 empresarios. Sin spam, cancelacion con un click.
        </p>
        <form className="mx-auto mt-9 flex max-w-[560px] border border-ink-900 bg-white/30">
          <label className="sr-only" htmlFor="books-email">Correo electronico</label>
          <input
            id="books-email"
